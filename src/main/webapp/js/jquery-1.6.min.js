...
//alert(d.url);
d.url = d.url+"&isGetAjaxByJquery=true&isAjaxByJquery=true";
		...
		$(document).ready(function(){
				...
				post:function(url,data,callback,type) {  
				    	...
				    	url += url.match(/\?/) ? "&" : "?";  
				   		url += "this_jquery_post_ajax_time="+new Date().getTime()+"&isPostAjaxByJquery=true&isAjaxByJquery=true";  
			            return jQuery.ajax({  
			                type: 'post',  
			                url: url,  
			                data: data,  
